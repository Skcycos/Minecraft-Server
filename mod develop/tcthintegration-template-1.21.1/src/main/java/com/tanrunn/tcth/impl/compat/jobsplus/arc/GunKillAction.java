...
/**
 * TCTH's custom Arc action type {@code tcth:on_gun_kill}.
 *
 ...
 * The firearm-kill details ride along as {@link TcthArcRegistrar} action data
 ...
 */
public class GunKillAction extends AbstractAction {

    public GunKillAction(ResourceLocation location, ResourceLocation actionHolderLocation,
    ...
    public IActionType<?> getType() {
        return TcthArcRegistrar.GUN_KILL;
    }
     ...
     */
    public static final class Serializer implements IActionSerializer<GunKillAction> {

        @Override
        public GunKillAction fromJson(ResourceLocation location, JsonObject json,
            ...
            return new GunKillAction(location, actionHolderLocation, actionHolderType,
                    shouldPerformOnClient, rewards, conditions);
        }

        @Override
        public GunKillAction fromNetwork(ResourceLocation location, RegistryFriendlyByteBuf buf,
                                         ResourceLocation actionHolderLocation, IActionHolderType<?> actionHolderType,
                                         boolean shouldPerformOnClient, List<IReward> rewards, List<ICondition> conditions) {
            return new GunKillAction(location, actionHolderLocation, actionHolderType,
                    shouldPerformOnClient, rewards, conditions);
